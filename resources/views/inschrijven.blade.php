                    ...
                    <div class="col-3">
                        <div class="form__section">
                            ...
                            <select
                                ...
                                class="form__select form__select--full-width"
                                required>
                                <option value="01" @if( old('geboortedatum')[0] == "01" ) selected @endif>1</option>
                                <option value="02" @if( old('geboortedatum')[0] == "02" ) selected @endif>2</option>
                                <option value="03" @if( old('geboortedatum')[0] == "03" ) selected @endif>3</option>
                                <option value="04" @if( old('geboortedatum')[0] == "04" ) selected @endif>4</option>
                                <option value="05" @if( old('geboortedatum')[0] == "05" ) selected @endif>5</option>
                                <option value="06" @if( old('geboortedatum')[0] == "06" ) selected @endif>6</option>
                                <option value="07" @if( old('geboortedatum')[0] == "07" ) selected @endif>7</option>
                                <option value="08" @if( old('geboortedatum')[0] == "08" ) selected @endif>8</option>
                                <option value="09" @if( old('geboortedatum')[0] == "09" ) selected @endif>9</option>
                                <option value="10" @if( old('geboortedatum')[0] == "10" ) selected @endif>10</option>
                                <option value="11" @if( old('geboortedatum')[0] == "11" ) selected @endif>11</option>
                                <option value="12" @if( old('geboortedatum')[0] == "12" ) selected @endif>12</option>
                                <option value="13" @if( old('geboortedatum')[0] == "13" ) selected @endif>13</option>
                                <option value="14" @if( old('geboortedatum')[0] == "14" ) selected @endif>14</option>
                                <option value="15" @if( old('geboortedatum')[0] == "15" ) selected @endif>15</option>
                                <option value="16" @if( old('geboortedatum')[0] == "16" ) selected @endif>16</option>
                                <option value="17" @if( old('geboortedatum')[0] == "17" ) selected @endif>17</option>
                                <option value="18" @if( old('geboortedatum')[0] == "18" ) selected @endif>18</option>
                                <option value="19" @if( old('geboortedatum')[0] == "19" ) selected @endif>19</option>
                                <option value="20" @if( old('geboortedatum')[0] == "20" ) selected @endif>20</option>
                                <option value="21" @if( old('geboortedatum')[0] == "21" ) selected @endif>21</option>
                                <option value="22" @if( old('geboortedatum')[0] == "22" ) selected @endif>22</option>
                                <option value="23" @if( old('geboortedatum')[0] == "23" ) selected @endif>23</option>
                                <option value="24" @if( old('geboortedatum')[0] == "24" ) selected @endif>24</option>
                                <option value="25" @if( old('geboortedatum')[0] == "25" ) selected @endif>25</option>
                                <option value="26" @if( old('geboortedatum')[0] == "26" ) selected @endif>26</option>
                                <option value="27" @if( old('geboortedatum')[0] == "27" ) selected @endif>27</option>
                                <option value="28" @if( old('geboortedatum')[0] == "28" ) selected @endif>28</option>
                                <option value="29" @if( old('geboortedatum')[0] == "29" ) selected @endif>29</option>
                                <option value="30" @if( old('geboortedatum')[0] == "30" ) selected @endif>30</option>
                                <option value="31" @if( old('geboortedatum')[0] == "31" ) selected @endif>31</option>
                            </select>
                    ...
                    <div class="col-5">
                        <div class="form__section">
                            ...
                            <select
                                ...
                                class="form__select form__select--full-width"
                                required>
                                <option value="01" @if( old('geboortedatum')[0] == "01" ) selected @endif>Januari</option>
                                <option value="02" @if( old('geboortedatum')[0] == "02" ) selected @endif>Februari</option>
                                <option value="03" @if( old('geboortedatum')[0] == "03" ) selected @endif>Maart</option>
                                <option value="04" @if( old('geboortedatum')[0] == "04" ) selected @endif>April</option>
                                <option value="05" @if( old('geboortedatum')[0] == "05" ) selected @endif>Mei</option>
                                <option value="06" @if( old('geboortedatum')[0] == "06" ) selected @endif>Juni</option>
                                <option value="07" @if( old('geboortedatum')[0] == "07" ) selected @endif>Juli</option>
                                <option value="08" @if( old('geboortedatum')[0] == "08" ) selected @endif>Augustus</option>
                                <option value="09" @if( old('geboortedatum')[0] == "09" ) selected @endif>September</option>
                                <option value="10" @if( old('geboortedatum')[0] == "10" ) selected @endif>Oktober</option>
                                <option value="11" @if( old('geboortedatum')[0] == "11" ) selected @endif>November</option>
                                <option value="12" @if( old('geboortedatum')[0] == "12" ) selected @endif>December</option>
                            </select>
