        ...
        <div class="col-12">
            @component('components.breadcrumbs', [
                'childs' => [
                    ...
                    (object)[
                        'link' => '/admin/activiteiten/'.$tak->slug,
                        'name' => $tak->naam,
                    ],
                ],
        ...
        <div class="section col-12">
            <form class="form" action="/admin/activiteiten/add" method="POST">
                ...
                <div class="wrapper__btn">
                    ...
                    <a href="{{ isset($tak) ? route('admin.activiteiten.tak', ['tak' => $tak->slug]) : url()->previous() }}" class="btn btn--error">Cancel</a>
                </div>
            </form>
        </div>
    </div>
