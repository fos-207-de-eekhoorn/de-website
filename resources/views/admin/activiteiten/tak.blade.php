    ...
    <div class="row section">
        ...
        <div class="section col-12">
            <div class="wrapper__btn wrapper__btn--right medium-margin-bottom">
                <a href="{{ route('admin.activiteiten.add', ['tak' => $tak->slug]) }}" class="btn btn--primary">
            ...
            @if (session('delete_success'))
                @component('components.flash_message', [
                    ...
                    <form action="{{ route('admin.activiteiten.remove.undo') }}" method="POST" class="medium-margin-left" style="display: inline;">
                        @csrf
                ...
                @forelse ($tak->activiteiten as $activiteit)
                    <tr class="table__row">
                        ...
                        <td class="table__cell no-wrap">
                            <p>
                                <a href="{{ route('admin.activiteiten.inschrijvingen', [Crypt::encrypt($activiteit->id)]) }}">
                            ...
                            <p>
                                <a href="{{ route('admin.activiteiten.edit', [Crypt::encrypt($activiteit->id)]) }}">
                                    <span class="fa--before"><i class="fas fa-pen"></i></span>Pas aan
                                </a>
                            </p>

                            <form action="{{ route('admin.activiteiten.remove.post') }}" method="POST" class="no-margin-bottom">
                                @csrf
