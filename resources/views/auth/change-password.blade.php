...
@section('content')
    @component('components.banner', [
        ...
        'page_title' => __('auth.change_password'),
    ])
    @endcomponent
    ...
    <div class="row section justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <form class="form" method="POST" action="{{ route('password.change.post') }}">
                @csrf

                <p class="info info--thirth-width">
                    <label for="current_password" class="info__label info__label--right">{{ __('auth.current_password') }}</label>

                    <span class="info__data">
                        <input id="current_password" type="password" name="current_password" class="form-control form__input form__input--full-width" required autofocus>
                ...
                {{-- Password --}}
                <p class="info info--thirth-width">
                    <label for="new_password" class="info__label info__label--right">{{ __('auth.new_password') }}</label>

                    <span class="info__data password-inside-feedback__parent">
                        <input id="new_password" type="password" name="new_password" class="form-control form__input form__input--full-width" required>
                ...
                {{-- Confirm password --}}
                <p class="info info--thirth-width">
                    <label for="new_password-confirm" class="info__label info__label--right">{{ __('auth.confirm_new_password') }}</label>

                    <span class="info__data password-inside-feedback__parent">
                        <input id="new_password-confirm" type="password" name="new_password_confirmation" class="form-control form__input form__input--full-width" required disabled>
    ...
    <script>
        (function ($) {
            var eInputPassword = document.getElementById('new_password'),
                eInputConfirm = document.getElementById('new_password-confirm'),
