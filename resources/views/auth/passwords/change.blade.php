    ...
    <div class="row justify-content-center">
        <div class="col-md-8 card">
            <div class="card__inner cs-white">
                <h3 class="card__title">{{ __('auth.change_password') }}</h3>
                ...
                <div class="card__content">
                    ...
                    <form class="form" method="POST" action="/change-password">
                        ...
                        <p class="info info--thirth-width">
                            <label for="new-password" class="info__label info__label--right">{{ __('auth.current_password') }}</label>

                            <span class="info__data">
                                <input id="current-password" type="password" name="current-password" class="form-control form__input form__input--full-width" required autofocus>
                        ...
                        {{-- Password --}}
                        <p class="info info--thirth-width">
                            <label for="new-password" class="info__label info__label--right">{{ __('auth.new_password') }}</label>

                            <span class="info__data password-inside-feedback__parent">
                                <input id="new-password" type="password" name="new-password" class="form-control form__input form__input--full-width" required>
                        ...
                        {{-- Confirm password --}}
                        <p class="info info--thirth-width">
                            <label for="new-password-confirm" class="info__label info__label--right">{{ __('auth.confirm_new_password') }}</label>

                            <span class="info__data password-inside-feedback__parent">
                                <input id="new-password-confirm" type="password" name="new-password_confirmation" class="form-control form__input form__input--full-width" required disabled>
                        ...
                        <div class="info card">
                            <div class="card__inner cs-blue cs-blue--gradient">
                                <h4 class="card__title">
                                    {{ __('global.password_advice') }}
                                </h4>

                                <div class="card__content">
                                    <ul>
                                        <li>{{ __('global.9_chars') }}</li>
...
<script>
    (function ($) {
        var eInputPassword = document.getElementById('new-password'),
            eInputConfirm = document.getElementById('new-password-confirm'),
